...
1. IDENTIFICACIÓN DE LOS CONTRIBUYENTES (USER 1 / USER 2):
   ...
   - Si recibes DOS documentos de declaración separados (DOCUMENTO 1 y DOCUMENTO 2):
     * El 'Declarante' o 'Primer declarante' que aparezca en el DOCUMENTO 1 es el Contribuyente 1 (User 1). Extrae su nombre completo y su NIF/DNI que figura en ese DOCUMENTO 1.
     * El 'Declarante' o 'Primer declarante' que aparezca en el DOCUMENTO 2 es el Contribuyente 2 (User 2). Extrae su nombre completo y su NIF/DNI que figura en ese DOCUMENTO 2. Establece 'hasPartner': true en el objeto de 'user2'.
   ...
   - Si recibes UN SOLO documento de declaración:
     * El 'Declarante' o 'Primer declarante' es el Contribuyente 1 (User 1). Extrae su nombre completo y su NIF/DNI.
